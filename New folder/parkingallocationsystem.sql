...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 25, 2016 at 08:37 PM
...
CREATE TABLE `floor` (
  ...
  `FloorOccupied` int(11) DEFAULT '0',
...
INSERT INTO `floor` (`Floor_id`, `FloorNumber`, `NumberOfSlot`, `FloorOccupied`, `Lot_id`) VALUES
('frl_1', '1st floor', 1, 0, 'pkl_9'),
('frl_2', '1st floor', 1, 0, 'pkl_9'),
('frl_3', '1st floor', 1, 0, 'pkl_9'),
('frl_4', '1st floor', 1, 0, 'pkl_9'),
('frl_5', '1st floor', 1, 0, 'pkl_10'),
('frl_6', '2nd floor', 1, 0, 'pkl_10'),
('frl_7', '3rd floor', 0, 0, 'pkl_10'),
('frl_8', '4th floor', 0, 0, 'pkl_10');
...
CREATE TABLE `parkingslot` (
  ...
  `ParkingType` char(1) DEFAULT NULL,
